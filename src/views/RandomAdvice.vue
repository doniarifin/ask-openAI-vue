<template>
  <div class="generaterandomadvice w-full">
    <div class="mb-4 w-full flex flex-col">
      ...
      <input type="text" v-model="input" id="word"
        ...
        placeholder="Enter a word" @keyup.enter="getAdvice(input)">
    </div>
    ...
    <div class="mb-6">
      <p :class="result == 'please enter one word.' ? 'mt-2 text-sm text-red-600' : 'text-green-600'"><span class="font-medium">{{
        result }}</span></p>
    </div>
  </div>
</template>
